...
var chatManager = /** @class */ (function () {
    ...
    chatManager.prototype.connect = function (clientID, ws) {
    ...
    chatManager.prototype.sendMessage = function (recipientID, senderID, content) {
        return __awaiter(this, void 0, void 0, function () {
            var recipientWS, message;
            return __generator(this, function (_a) {
                console.log("recipient id is :", recipientID);
                console.log("sender id is :", senderID);
                recipientWS = this.clients.get(recipientID);
                if (!recipientWS) {
                    console.log("reciever not found");
                }
                message = JSON.stringify({ senderID: senderID, content: content });
                recipientWS === null || recipientWS === void 0 ? void 0 : recipientWS.send(message);
                console.log("message sent");
                return [2 /*return*/];
            });
        });
    };
    chatManager.prototype.handleMessages = function (message, ws) {
